...
// please modify need_calc_json_as_text if other json functions are added
  ...
  T_FUN_TOKENIZE = 2050,
  T_FUN_WHITESPACE_TOKENIZE = 2051,
  T_FUN_SYS_CALC_SUB_PARTITION_ID = 2052,
  T_FUN_SYS_CALC_PARTITION_NAME = 2053,
  T_FUN_SYS_CALC_SUB_PARTITION_NAME = 2054,
  T_FUN_SYS_CALC_PARTITION_IDX = 2055,
  T_FUN_SYS_CALC_SUB_PARTITION_IDX = 2056,
  T_FUN_SYS_CALC_ODPS_SIZE = 2057,
  T_FUN_URL_ENCODE = 2058,
  T_FUN_URL_DECODE = 2059,
  T_FUN_SYS_DEMOTE_CAST = 2060,
  T_FUN_SYS_RANGE_PLACEMENT = 2061,
  T_FUN_SYS_INNER_INFO_COLS_COLUMN_DEF_PRINTER = 2062,
  T_FUN_SYS_INNER_INFO_COLS_CHAR_LEN_PRINTER = 2063,
  T_FUN_SYS_INNER_INFO_COLS_CHAR_NAME_PRINTER = 2064,
  T_FUN_SYS_INNER_INFO_COLS_COLL_NAME_PRINTER = 2065,
  T_FUN_SYS_INNER_INFO_COLS_PRIV_PRINTER = 2066,
  T_FUN_SYS_INNER_INFO_COLS_EXTRA_PRINTER = 2067,
  T_FUN_SYS_INNER_INFO_COLS_DATA_TYPE_PRINTER = 2068,
  T_FUN_SYS_INNER_INFO_COLS_COLUMN_TYPE_PRINTER = 2069,
  T_FUN_SYS_RB_OR_CARDINALITY_AGG = 2070,
  T_FUN_SYS_RB_AND_CARDINALITY_AGG = 2071,
  T_FUN_SYS_RB_TO_ARRAY = 2072,
  T_FUN_SYS_RB_CONTAINS = 2073,
  T_FUN_INNER_PREFIX_MIN = 2074,
  T_FUN_INNER_PREFIX_MAX = 2075,
  T_FUN_SYS_INNER_INFO_COLS_COLUMN_KEY_PRINTER = 2076,
  T_FUN_ARG_MIN = 2077,
  T_FUN_ARG_MAX = 2078,
  T_FUN_TMP_FILE_OPEN = 2079,
  T_FUN_TMP_FILE_CLOSE = 2080,
  T_FUN_TMP_FILE_WRITE = 2081,
  T_FUN_TMP_FILE_READ = 2082,
  T_FUN_SYS_AI_COMPLETE = 2083,
  T_FUN_SYS_AI_EMBED = 2084,
  T_FUN_SYS_AI_RERANK = 2085,
  T_FUN_MD5_CNN_WS = 2086,
  T_FUN_SYS_BUCKET = 2087,
  T_MAX_OP = 3000,
